...
class Ui_DetailsPanelWidget(object):
    def setupUi(self, DetailsPanelWidget):
        ...
        self.info_layout.setContentsMargins(0, 5, -1, 0)
        ...
        self.line_2 = QtGui.QFrame(self.entity_note_tab)
        ...
        self.horizontalLayout_5.addWidget(self.version_fields_button)
        ...
        self.version_sort_by_field = QtGui.QComboBox(self.version_top_layout)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.version_sort_by_field.sizePolicy().hasHeightForWidth())
        self.version_sort_by_field.setSizePolicy(sizePolicy)
        self.version_sort_by_field.setSizeAdjustPolicy(QtGui.QComboBox.AdjustToContents)
        self.version_sort_by_field.setObjectName("version_sort_by_field")
        self.horizontalLayout_3.addWidget(self.version_sort_by_field)
    ...
    def retranslateUi(self, DetailsPanelWidget):
        ...
        self.more_fields_button.setText(QtGui.QApplication.translate("DetailsPanelWidget", "Fields...", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.version_fields_button.setText(QtGui.QApplication.translate("DetailsPanelWidget", "Fields...", None, QtGui.QApplication.UnicodeUTF8))
        self.label.setText(QtGui.QApplication.translate("DetailsPanelWidget", "Sort by:", None, QtGui.QApplication.UnicodeUTF8))
